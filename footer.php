<!-- Footer Starts -->
<div class="footer text-center spacer_footer">
    <p class="wowload flipInX">
        <a href="https://www.facebook.com/brianhuieseattle"><i class="fa fa-facebook fa-2x"></i></a> 
        <a href="https://twitter.com/brianh_seattle"><i class="fa fa-twitter fa-2x"></i></a>  
        <a href="https://plus.google.com/+BrianHuieSeattle/posts"><i class="fa fa-google-plus fa-2x"></i></a> 
        <a href="https://www.linkedin.com/in/brianhuieseattle"><i class="fa fa-linkedin fa-2x"></i></a> 
        <a href="https://www.pinterest.com/brianhuie/"><i class="fa fa-pinterest fa-2x"></i></a>
    </p> 
    <p>
    <a href="http://portal.hud.gov/hudportal/HUD?src=/program_offices/fair_housing_equal_opp" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/equal-housing.png" alt="img01"/></a>
    </p>
    <p><b>Direct Phone:</b> 206-708-9699 <br> <b>Bellevue Office:</b> 845 106th Ave NE, Suite 200 Bellevue, WA 98004 <br> <b>Capitol Hill Office:</b> 320 East Pine, Suite 110, Seattle, WA 98122 </p> 
    <p>© 2016 Brian Huie | WP & Associates. All Rights Reserved.</p> 
</div>
<!-- # Footer Ends -->
	 ...
	 <div id="myCarousel" class="carousel slide banner-slider animated bounceInDown" data-ride="carousel">     
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="<?php bloginfo('template_directory'); ?>/images/back1.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->

        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/back2.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->

        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/back3.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->

        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/back4.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="">
		  ...
		  <img src="<?php bloginfo('template_directory'); ?>/images/team/brian_huie.jpg" class="img-responsive" alt="our team">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			  <p class="img-descr h3">Brian Huie</p>
			  <p class="img-descrip h4">Lead broker / Residential & Investment Consultant</p>
			  </div>
      </div>
      <div class="modal-body">  
		  <h5>EXPERIENCE.</h5>
<p class="body-description">Brian began in real estate 12 years ago as an investor. While a sophomore at the University of Idaho, he purchased his first home and commercial property with a personal loan from a military bank. He continued buying, renovating, renting, and selling as a hobby before finally deciding to help others buy and sell. Before he entered sales, he had already solidified his expertise and skills in negotiations. In his first 12 months of sales, alone, he sold tens of millions in residential and investment properties, negotiated hundreds of thousands in closing costs and credits, and has helped dozens of first time home buyers find their first home, all single handedly and without a team. He now has a team based out of Capitol Hill where he trains and strategizes with daily ensure more buyers and sellers get the same attention, dedication, and rewards that he has always delivered..</p>
		  <h5>PASSION.</h5>	
<p class="body-description">His professionalism and expertise are second only to his passion for helping others. He is passionate about protecting his client throughout the entire process of buying or selling a home. Simply finding a home or a buyer for a home is the job of any broker; finding a home or buyer, researching, providing resources, strategizing, negotiating, and guiding you along the way as a full service consultant is how he differs. He’s been known to make sacrafices to ensure the safety of his clients. Brian is more than just your broker, but your friend to make your experience as stress­-free as possible before, during, and after your transaction.</p>
		  <h5>SERVICE.</h5>
<p class="body-description">Helping others is simply his nature. Local volunteer with Seattle Works, Seattle OneBrick, Roxhill Elementary, and the 45th Street Homeless Youth Clinic. Nationally, he has mentored at­-risk children as an AmeriCorps Volunteer, Students-­in­-Service volunteer, and served in the US Air Force where he learned, “Integrity first, service before self, and excellence in all”.</p>

NOW LET HIM SERVE YOU!
		 <div class="social">
		<a href="https://www.facebook.com/brianhuieseattle"><i class="fa fa-facebook fa-2x"></i></a> 
        <a href="https://twitter.com/brianh_seattle"><i class="fa fa-twitter fa-2x"></i></a>  
        <a href="https://plus.google.com/+BrianHuieSeattle/posts"><i class="fa fa-google-plus fa-2x"></i></a> 
...
<!-- Member #2 -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="">
		  <div class="img-container">
		  <img src="<?php bloginfo('template_directory'); ?>/images/team/avery_southern-1.jpg" class="img-responsive" alt="our team">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			  <p class="img-descr h3">Avery Southern</p>
			  <p class="img-descrip h4">Transaction Coordinator</p>
			  </div>
      </div>
      <div class="modal-body">
<p class="body-description">Avery fell in love with the city of Seattle when she was very young. All of the unique, diverse architecture and bustle of the city inspired her early on, eventually leading her to becoming a real estate broker. She has a soft spot for the old historical buildings mixed with new modern high rise construction that’s so prevalent in Seattle.<br>
Her love for meeting new people and hearing their stories ties in perfectly with the work she does. Nothing makes her happier than knowing she can make a living doing what she loves, and helping people in the process. Her passion for connecting with people paralleled with her expertise makes for an above and beyond home buying/selling process.</p>
		 <div class="social">
		  <a href="https://www.facebook.com/profile.php?id=100004795834518"><i class="fa fa-facebook fa-2x"></i></a></div>
      </div>
      <div class="text-center">
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
      </div>
...
<!-- Member #3 -->
    <div id="normalModal8" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="">
		  <div class="img-container">
		  <img src="<?php bloginfo('template_directory'); ?>/images/team/kayla_iwakami.jpg" class="img-responsive" alt="our team">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			  <p class="img-descr h3">Kayla Iwakami</p>
			  <p class="img-descrip h4">Broker</p>
			  </div>
      </div>
      <div class="modal-body">
<p class="body-description">Kayla Iwakami is a young, hard working, energetic, socialite with a passion for real estate. Kayla is an athlete by nature, growing up in a family surrounded by sports, Kayla loves playing soccer and exploring the beautiful Pacific Northwest with her Labrador puppy. Kayla fell in love with the family atmosphere neighborhoods she was born and raised in and looks forward to getting to know more of her community on a personal level. With over eight years of customer service whether you are buying or selling Kayla is here to help you with your real estate needs, she understands that each client is unique and looks forward to helping you find your perfect dream home! Give Kayla a call today.</p>
		 <div class="social">
		  <a href="https://www.facebook.com/kayla.iwakami"><i class="fa fa-facebook fa-2x"></i></a><a href="http://www.pictaram.com/user/kayyyyiwak/7997123 "><i class="fa fa-instagram fa-2x"></i></a></div>
      </div>
      <div class="text-center">
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
      </div>
...
<!-- Member #3 -->
    <div id="normalModal9" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="">
		  <div class="img-container">
		  <img src="<?php bloginfo('template_directory'); ?>/images/team/lucy_meng.jpg" class="img-responsive" alt="our team">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			  <p class="img-descr h3">Lucy Meng</p>
			  <p class="img-descrip h4">Broker</p>
			  </div>
      </div>
      <div class="modal-body">
<p class="body-description"></p>
		 <div class="social">
		  <a href=""><i class="fa fa-facebook fa-2x"></i></a><a href=""><i class="fa fa-instagram fa-2x"></i></a></div>
      </div>
      <div class="text-center">
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
      </div>
...
<!-- Member #4 -->
    <div id="normalModal10" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="">
		  <div class="img-container">
		  <img src="<?php bloginfo('template_directory'); ?>/images/team/sean_so-1.jpg" class="img-responsive" alt="our team">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			  <p class="img-descr h3">Sean So</p>
			  <p class="img-descrip h4">Broker / Residential and Restaurant Consultant</p>
			  </div>
      </div>
      <div class="modal-body">
<p class="body-description">Sean gained his experience and professionalism early on at the age of fourteen. He began working as a Teppanaki Chef in his home town of Bellingham WA. While cooking for his clients in a very personable and engaging environment, he developed his communication and listening skills at a very young age. He was able to continue and learn these traits while finishing up high school and into culinary school at Bellingham Technical College. After culinary school he moved to Seattle where he continued his passion for cooking and sales. Sean then went to Benihana Seattle. After spending a year at Benihana and gaining tons of experience in a large corporate franchise he went on to help a friend open up a restaurant in Pioneer Square for the next two years.</p>

<p class="body-description">After spending 10 years working in restaurants, he decided to take his passion for food and his love of sales and combine them. He joined a  startup company, heading up the Sales Department of a three man operation food distribution company. The mission was to help create a local and sustainable food culture you see in Pacific Northwest today. Sean spent the last nine years building a company as Vice President. During which he developed incredible negotiating skills, writing contracts, whole sale volume purchasing and selling products to some of the largest food institutions and highest end restaurants in Washington and Oregon. Sean’s nature has always been to get the job done and willing to work 24 hours a day to care for his clients.</p>

<p class="body-description">Sean brings his own personal experiences of buying and selling real estate to help educate folks on: the benefits of owning a home vs renting, how to make money on investment properties and what area’s to watch for when thinking of making a purchase. He’s also aligned himself with mentors and friends who have over 30 years of experience in both Real Estate, Investments and Lending. He would like to offer an amazing experience from the moment he brings you on as a client whether you’re a buyer, seller, and investor or if you simply just have a  question.<br>
Thanks for meeting him, Sean.
</p>
...
<!-- Member #6 -->
    <div id="normalModal11" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
		  <h4>Jason Harrington J.D.</h4>
		  <h5>Residential and Legal Consultant</h5>
<p class="body-description">Jason has practiced commercial, property, environmental, construction and personal injury litigation for over 12 years. He has represented business and property owners, equipment owners and lessors, condominium associations, general and subcontractors, architects and engineers, insurance companies, environmental consultants, retailers and individuals in a wide‐variety of matters from inception through resolution. This experience further includes assisting clients in an array of contractual and transactional matters, and negotiating agreements.</p>
...
<!-- Listing#1 -->
    <div id="normalModal3" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
	  <div class="modal-content">
<div id="carousel-example-generic-modal-3" class="carousel slide" data-ride="carousel">
	<div class="carousel-inner">
        <!-- Item 1 -->
        <div class="item active">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.1.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->
        ...
        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.2.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->

        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.3.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.4.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.5.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.6.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.7.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.8.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.9.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.10.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.11.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.12.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.13.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.14.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-1.15.jpg" alt="banner">
        </div>
      </div>
     	<!-- Controls -->
  <a class="left carousel-control" href="#carousel-example-generic-modal-3" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left"></span>
  </a>
  <a class="right carousel-control" href="#carousel-example-generic-modal-3" role="button" data-slide="next">
...
<!-- Listing#2 -->
<div id="normalModal4" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div id="carousel-example-generic-modal" class="carousel slide" data-ride="carousel">
<div class="carousel-inner">
        <!-- Item 1 -->
        <div class="item active">
          <img src="<?php bloginfo('template_directory'); ?>/images/house-2.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->

        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.1.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->

        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.2.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->

        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.3.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->
		 
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.5.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.6.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.7.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.8.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.9.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.10.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.11.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.12.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.13.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.14.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.15.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.16.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.17.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.18.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.19.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.20.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.21.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.22.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-2.23.jpg" alt="banner">
        </div>
      </div>
		<!-- Controls -->
  <a class="left carousel-control" href="#carousel-example-generic-modal" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left"></span>
  </a>
  <a class="right carousel-control" href="#carousel-example-generic-modal" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right"></span>
  </a>
</div>
		<div class="modal-body">
...
<div id="normalModal5" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  ...
  <div class="carousel-inner">
    <!-- Item 1 -->
        <div class="item active">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.1.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->
        ...
        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.2.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->

        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.3.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.4.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.5.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.6.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.7.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.8.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.9.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.10.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.11.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.12.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.13.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.14.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.15.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.16.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.17.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.18.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.19.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.20.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.21.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.22.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.23.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-3.24.jpg" alt="banner">
        </div>
      </div>
...
<!-- Listing#4 -->
<div id="normalModal6" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
  ...
  <div class="carousel-inner">
        <!-- Item 1 -->
        <div class="item active">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.1.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->
        ...
        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.2.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->

        <!-- Item 1 -->
        <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.3.jpg" alt="banner">
        </div>
        <!-- #Item 1 -->
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.4.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.5.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.6.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.7.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.8.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.9.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.10.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.11.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.12.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.13.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.14.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.15.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.16.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.17.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.18.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.19.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.20.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.21.jpg" alt="banner">
        </div>
		  <div class="item">
          <img src="<?php bloginfo('template_directory'); ?>/images/houses/house-4.22.jpg" alt="banner">
        </div>
		  <div class="item">
  ...
  <a class="right carousel-control" href="#carousel-example-generic-1" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right"></span>
		...
		<div class="modal-body">
		  ...
		  <div class="col-md-4 col-xs-4"><p class="home-details">4<br>bath</p></div>
		<div class="col-md-4 col-xs-4"><p class="home-details">2,952<br>sqfs</p></div>
</div>
			  </div>        
...
<!-- Community -->
<div id="normalModal7" class="portfolio-modal modal fade" tabindex="-1" role="dialog" aria-hidden="true">
<div class="modal-content">
...
<div class="modal-body">
<div class="container popup block_desktop">
<div class="row">
<div class="col-lg-12 col-md-12 col-sm-12">
 <div class="col-lg- col-md-3 col-sm-3 text-right popup_colums" >
                    <ul class="sidebar-nav nav popup_side_menu">
                        <li><a class="btn_belletown" href="#">Belletown</a></li>
                        <li><a class="btn_ballard" href="#">Ballard</a></li>
                        <li><a class="btn_beacon_hill" href="#">Beacon Hill</a></li>
                        <li><a class="btn_capitol_hill" href="#">Capitol Hill</a></li>
                        <li><a class="btn_central_district" href="#">Central District</a></li>
                        <li><a class="btn_green_lake" href="#">Green Lake</a></li>
                        <li><a class="btn_east_lake" href="#">East Lake</a></li>
                        <li><a class="btn_queen_anne" href="#">Queen Anne</a></li>
                        <li><a class="btn_south_lake_union" href="#">South Lake Union</a></li>
                        <li><a class="btn_west_lake" href="#">West Lake</a></li>
                    </ul>
                </div>   
<div class="col-lg-9 col-md-9 col-sm-9 text-left">
<div class="belletown" id="fade">
...
Belltown is one of Seattle’s oldest neighborhoods and is considered to be an urban oasis. There are so many things to do near Belltown condos for sale. Residents have ample parks, p-patch gardens, the historic Cottage Park and the Olympic Sculpture Park. Olympic Sculpture Park is on the Elliott Bay waterfront and combines natural elements and public art work. It is free and open all year long. If you want a bite to eat, Taste at the <a class="links" href="http://www.seattleartmuseum.org/visit/olympic-sculpture-park" target="_blank">Olympic Sculpture</a> Park serves baked goods, espresso and other snacks.<br><br>

There are also many entertainment venues within Belltown Seattle real estate. Watch live music at Dimitriou’s Jazz Alley or Moore Theatre. A few dining options include Assaggio Restorante, Brasserie Margaux, Dahlia Lounge, Golden Singha, Hurricane Cafe, Buenos Aires Grill, Petra Bistro, Spur, Zeitoon Cafe & Bistro, Bathtub Gin & Co., The 5 Point Cafe and much more. Other classic landmarks Belltown is home to are the Art Institute of Seattle, Seattle School of Theology & Psychology, RealNetworks, Antioch Univserity, and Argosy Univserity.<br><br>

It is very easy to get around Belltown. There are free bus lines on the <a class="links" href="http://kingcounty.gov/depts/transportation/metro/travel-options/bus.aspx" target="_blank">King County Metro Bus </a>, so residents can get all over town without dropping a dime. Pike Place Market is famous farmers’ market with local goods and produce. Seattle is a such a great place to live, work and play. Downtown Seattle is just a short walk from Belltown condos for sale.<br><br>
...
Central District Seattle real estate is located near a variety of cultural institutions. There are several educational and artistic programs at the Pratt Fine Arts Center, <a class="links" href="http://www.langstoninstitute.org/" target="_blank">Langston Hughes Cultural Arts Center,</a> Central District Forum for Arts & Ideas and Northwest African American Museum. Residents can immerse themselves in culture. Cultural inspirations that have once called Central District home include jazz musician Ray Charles, Bruce Lee, Jimi Hendrix and Minoru Yamasaki, a New York Trade Center architect.<br><br>

If you have kids that possess strong musical ambitions, then Central Seattle homes for sale are the place for you. Garfield High School produces the largest amount of Seattle’s National Merit Scholars. The school boasts spectacular jazz programs. Students are fed from Washington Middle School and Seattle Central College and Seattle University are nestled in this neighborhood.<br><br>

You’ll also be happy to find an array of dining and shopping choices surrounding Central Seattle District homes for sale. The popular Skillet food truck has expanded to an actual restaurant and still has their famous bacon jam. The food is just as unique as the people. There is Spanish, Vietnamese, Haitian, and Ethiopian cuisines. Ezell’s Fried Chicken, Taste of the Caribbean, The Barbeque Pit, Sam’s Moroccan Sandwich Shop, Cheeky Cafe, The Neighbor Lady and The Moonlight Cafe are fine examples of great food.<br><br>
...
Shopping choices near Green Lake homes for sale include a variety of boutiques and unique shops, like Mockingbird Books, Green Lake Games, Frock Shop, PCC Natural Markets, and Ageing Fancies. <a class="links" href="http://www.simon.com/mall/northgate-mall" target="_blank">Northgate Mall</a> is also close by for big name stores like JCPenney, Nordstrom, Macy’s, Bath & Body Works, and Express among many others.<br><br>

Those living in Green Lake real estate have many yummy restaurants, eateries and cafes to choose from. Some of the delicious options are <a class="links" href="http://www.nellsrestaurant.com/" target="_blank">Nell’s Restaurant,</a> Mykonos Greek Grill, Hot Diggity, Cloud City Coffee, Garlic Jim’s, and Stumbling Goat Bistro. There’s a restaurant to suit practically every taste and mood.<br><br>
...
Residents can enjoy some great entertainment at the many local spots near Eastlake homes for sale. Eastlake Zoo Tavern provides shuffleboard, darts, pool and great food. With views of the lake and boats, Eastlake Bar and Grill or Serafina are the best spots. The main thoroughfare is Eastlake Avenue running north and south through the community. This is where you’ll find shopping, bakeries and other dining. <br><br>
...
Queen Anne Seattle homes for sale are near five public schools as well as private schools. Seattle Public Schools in the area include Frantz Coe Elementary, John Hay Elementary, Queen Anne Elementary, McClure Middle School and The Center School. Seattle Pacific University is also located on the north slope of Queen Anne.<br><br>
...
There are also many fun things to see near South Lake Union Seattle real estate. For outdoor recreation, Lake Union Park offers green space, wading pool walking paths, a model boat pond and a boating dock for residents to get out on the water. There are boat rentals, historic vessels, sailing classes, events and festivals. It is situated on 12 acres at the water’s edge.<br><br>

The Center for Wooden Boats allows residents to rent rowboats, kayaks or sailboats. The <a class="links" href="http://www.mohai.org/" target="_blank">Museum of History & Industry </a> displays a collection of maritime heritage and history of the community. You can see panoramic views of the city through the periscopes or grab a glass of wine at the local winery, Stomani Cellars.<br><br>
...
This is a great place for professionals and singles as well as retirees. It’s just a short bus trip to Pike Place Market and the Seattle Center. There are plenty of waterfront seafood restaurants such as McCormick and Schmick’s Seafood. There is also a Jillian’s Pool hall, China Harbor Restaurant and Outback Steakhouse. If you love the water and are looking for a lovely place to live in the Seattle area, Westlake homes for sale are for you.<br><br>
	...
	<div class="text-center">
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
                ...
                <!--
                <div class="container">
                  <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo">Belletown</button>
...
<!-- Services -->
<div id="normalModal12" class="portfolio-modal modal fade" tabindex="-1" role="dialog" aria-hidden="true">
<div class="modal-content">
<div class="close-modal" data-dismiss="modal">
<div class="lr">
<div class="rl">
...
<div class="modal-body">
    <div class="container popup block_desktop">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="col-lg- col-md-3 col-sm-3 text-right popup_colums" >
                    <ul class="sidebar-nav nav popup_side_menu_services">
                        <li><a class="btn_steps_to_buying" href="#">Steps to Buying</a></li>
                        <li><a class="btn_facts_and_common_myths" href="#">Facts & Common Myths</a></li>
                        <li><a class="btn_technology_and_cervices" href="#">Technology & Services</a></li>
                        <li><a class="btn_resources" href="#">Resources</a></li>
                    </ul>
                </div>   
                <div class="col-lg-9 col-md-9 col-sm-9 text-left">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 text-left">
                    <div class="steps_to_buying">
                        <h4 class="service_header text-center">Steps to Buying a House</h4> 
                        ...
                        <h5 class="service_subheader">Find a lender</h5>
                        <p>Ask your broker for their preferred lender. Pre-approval is essential to strike as soon as you come across your dream home. The speed of the offer can greatly affect the purchase price.</p>
                        <h5 class="service_subheader">Search</h5>
                        <p>It’s normal to have long periods of time where no new listings stand out, but it is important to maintain communications with your broker and lender. Your broker scans through over a hundred new listings a day.</p>
                        <h5 class="service_subheader">Submit an offer</h5>
                        <p>Time is of the essence and your broker has strategies to submit your offer. Review, scrutinize, and sign any documents for your broker as soon as possible.</p>
                        <h5 class="service_subheader">Stay close to your phone!</h5>
                        <p>Negotiations may begin as soon as the seller reviews the offer. Stay close to your phone but at the same time, keep yourself from becoming too anxious as it may take days to hear back.</p>

                        
                        <h5 class="service_subheader">Inspect home</h5>
                        <p>If the offer is accepted, the next step is to inspect the home. The inspector will identify defects while educating you on home maintenance.</p>
                        <h5 class="service_subheader">Open escrow</h5>
...
<button class="btn btn-primary popup_btn "><i class="fa fa-paper-plane"></i> Contact Us</button>
        ...
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
                    ...
                    <div class="facts_and_common_myths">
                        <h4 class="service_header text-center">Facts & Common Myths</h4> 
                        ...
                        <p>Whether a buyer uses their agent or not, the seller will pay the same
commission. It’s of the best interest of the buyer to have someone educating, negotiating, and protecting.</p>
                        <h5 class="service_subheader">Full-time vs. Part-time:</h5>
                        <p>Most agents are part-time or even hold other jobs. Full-time, full-service brokers have full-time attention for you and your search, and cost you the same — free!</p><br>
                        
                        <h5 class="service_header">Common Myths</h5> <hr>
                        <h5 class="service_subheader">Myth: <span class="inline_paragraph">You should wait until you’re serious before talking to a broker.</span></h5>
                        <h5 class="service_subheader">Truth: <span class="inline_paragraph">A quality broker will have resources to guide you and be able to help you even in the initial stages. They may even take you on a tour of homes to teach you what to look for and consider before you are ready to buy. Be wary of brokers who ask you to contact them only when you’re “serious” or “ready”.</span></h5> <br>
                        
                        <h5 class="service_subheader">Myth: <span class="inline_paragraph">You get the best deal from discount brokers or ones who lure you in with buyer credits/refunds.</span></h5>
                        <h5 class="service_subheader">Truth: <span class="inline_paragraph">A quality broker will negotiate the absolute best deal for you in any situation you are in. Brokers who offer buyer credits, such as those who work for discount firms, work with many buyers at a time thus are unable to give you the that you deserve. For example: you receiving $4,000 in credits may cost you $8,000 in closing costs and tens of thousands in other negotiations a full service, fully attentive broker would have won for you.!</span></h5> <br>
...
<button class="btn btn-primary popup_btn "><i class="fa fa-paper-plane"></i> Contact Us</button>
        ...
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
                    ...
                    <div class="technology_and_cervices">
                        <h4 class="service_header text-center">Technology & Services</h4> 
                        ...
                        <h5 class="service_subheader">Communicate Your Way</h5>
                        <p>We tailor our communication to your personal preferences. Whether it be text message, phone call, email or Facebook messaging. We’ll even video chat if you can’t make it to a showing.</p>
                        <h5 class="service_subheader">Helping You During All Stages</h5>
                        <p>We provide support and resources from the second you consider buying a home. We’ll give you our full attention and array of resources, whether you’re a first-time homebuyer or a seasoned investor.</p>
...
<button class="btn btn-primary popup_btn "><i class="fa fa-paper-plane"></i> Contact Us</button>
        ...
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
                    ...
                    <div class="resources">
                        <h4 class="service_header text-center">Resources</h4> 
...
permits, locating properties, looking up property values, and more.</p>
                        <h5 class="service_subheader"> <a class="links" href="http://money.cnn.com/pf/money-essentials-homebuying/" target="_blank">Buying a Home: A Buyer’s Guide</a></h5>
                        <p>Valuable tips to make the home buying process less complicated.</p>
                        <h5 class="service_subheader"> <a class="links" href="http://money.cnn.com/calculator/real_estate/homeafford/" target="_blank">Home Affordability Calculator</a></h5>
...
<!-- Sell -->
<div id="normalModal16" class="portfolio-modal modal fade" tabindex="-1" role="dialog" aria-hidden="true">
<div class="modal-content">
<div class="close-modal" data-dismiss="modal">
<div class="lr">
<div class="rl">
	 ...
	 <div class="container popup block_desktop">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="col-lg- col-md-3 col-sm-3 text-right popup_colums" >
                    <ul class="sidebar-nav nav popup_side_menu_services">
                        <li><a class="btn_steps_to_selling" href="#">Steps to Selling</a></li>
                        <li><a class="btn_strategies" href="#">Strategies</a></li>
                        <li><a class="btn_technology" href="#">Technologies</a></li>
                        <li><a class="btn_resources" href="#">Resources</a></li>
                    </ul>
                </div>   
                <div class="col-lg-9 col-md-9 col-sm-9 text-left">
                    <h3 class="text-center">Strategies & Tips To Efficiently Sell Your Home</h3>    
                </div>
                <div class="col-lg-9 col-md-9 col-sm-9 text-left">
                    <div class="steps_to_selling">
                        <h4 class="service_header text-center">Steps to Selling a House</h4> 
                        ...
                        <h5 class="service_subheader">Decide on sales terms and a listing price.</h5>
                        <p>Explain to the broker what your wants and needs are, there are limitless options to structure a transaction.!</p>
                        <h5 class="service_subheader">Prepare for the sale.</h5>
                        <p>A quality broker will have the tools, strategies, and suggestions to get your home ready to sell in the shortest amount of time and for the highest sales price.</p>
                        <h5 class="service_subheader">List the home.</h5>
                        <p>Once the home is listed on the NWMLS, it will be syndicated to hundreds of other databases.</p>
                        <h5 class="service_subheader">Review, negotiate, and accept offers.</h5>
                        <p>Depending on what strategy your broker recommends, you will probably meet for several hours reviewing multiple offers to decide on the best offer.</p>
                        <h5 class="service_subheader">Inspections, negotiations and transaction.</h5>
                        <p>The transaction phase is when multiple important parties, such as lender, title, escrow, attorneys, other agents, are hard at work behind the scene.</p>
                        <h5 class="service_subheader">Signing and Close.</h5>
...
<button class="btn btn-primary popup_btn "><i class="fa fa-paper-plane"></i> Contact Us</button>
        ...
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
                    ...
                    <div class="strategies">
                        <h4 class="service_header text-center">Our Strategies</h4> 
        ...
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
                    ...
                    <div class="technology">
                        <h4 class="service_header text-center">Our Technologies</h4> 
...
professional photoshoot with lighting and a variety of cameras.</span></h5>
                        <h5 class="service_subheader">Online Scheduling Service by SHOWINGTIME <span class="inline_paragraph">for instant 24/7 communication for prospective buyer or agent to request showings.</span></h5>
...
FOLIO: <span class="inline_paragraph">Your broker will give you frequent updates and provide you with a real-time, detailed timeline of your home selling process.</span></h5><br>      
        ...
        <button type="button" class="btn btn-close" data-dismiss="modal">Close</button>
                    ...
                    <div class="resources">
                        ...
                        <h5 class="service_subheader"> <a class="links" href="http://www.investopedia.com/articles/mortgages-real-estate/08/home-seller-mistakes-selling-house.asp" target="_blank">Mistakes to Avoid When Selling</a></h5>
                        <p>Uses your annual income, and monthly debts to
calculate how much house you can really afford.</p>
...
<script src="<?php bloginfo('template_directory'); ?>/js/modals.js"></script>
...
<script>
    /*
    function myNeighborhoods(n){ 
    var btn_neighborhoods = [".btn_belletown", ".btn_belletown", ".btn_ballard", ".btn_beacon_hill", ".btn_central_district", ".btn_green_lake", ".btn_east_lake", ".btn_queen_anne", ".btn_south_lake_union", ".btn_west_lake"]; 
    var neighborhoods = [".belletown", ".belletown", ".ballard", ".beacon_hill", ".central_district", ".green_lake", ".east_lake", ".queen_anne", ".south_lake_union", ".west_lake"]; 
    for (i = 0; i < neighborhoods.length; i++) {
        if (n = neighborhoods[i]){
            $(document).ready(function(){
                $(btn_neighborhoods[i]).click(function(){
                    $(neighborhoods[i]).fadeIn(1000);
                });
            });
        }
        else{
...
$(window).load(function () {
    $(".belletown").fadeIn(1000);
    $(".ballard").hide();
    $(".beacon_hill").hide();
    $(".capitol_hill").hide();
    $(".central_district").hide();
    $(".green_lake").hide();
    $(".east_lake").hide();
    $(".queen_anne").hide();
    $(".south_lake_union").hide();
    $(".west_lake").hide();
});
...
$(document).ready(function(){
    ...
    $(".btn_beacon_hill").click(function(){
        $(".belletown").hide();
        $(".ballard").hide();
        $(".beacon_hill").fadeIn(1000);
        $(".capitol_hill").hide();
        $(".central_district").hide();
        $(".green_lake").hide();
        $(".east_lake").hide();
    ...
    $(".btn_capitol_hill").click(function(){
        $(".belletown").hide();
        $(".ballard").hide();
        $(".beacon_hill").hide();
        $(".capitol_hill").fadeIn(1000);
        $(".central_district").hide();
        $(".green_lake").hide();
        $(".east_lake").hide();
        $(".queen_anne").hide();
    ...
    $(".btn_central_district").click(function(){
        $(".belletown").hide();
        $(".ballard").hide();
        $(".beacon_hill").hide();
        $(".capitol_hill").hide();
        $(".central_district").fadeIn(1000);
        $(".green_lake").hide();
        $(".east_lake").hide();
        $(".queen_anne").hide();
        $(".south_lake_union").hide();
    ...
    $(".btn_green_lake").click(function(){
        $(".belletown").hide();
        $(".ballard").hide();
        $(".beacon_hill").hide();
        $(".capitol_hill").hide();
        $(".central_district").hide();
        $(".green_lake").fadeIn(1000);
        $(".east_lake").hide();
        $(".queen_anne").hide();
        $(".south_lake_union").hide();
        $(".west_lake").hide();
    });
    $(".btn_east_lake").click(function(){
        $(".belletown").hide();
        $(".ballard").hide();
        $(".beacon_hill").hide();
        $(".capitol_hill").hide();
        $(".central_district").hide();
        $(".green_lake").hide();
        $(".east_lake").fadeIn(1000);
        $(".queen_anne").hide();
        $(".south_lake_union").hide();
        $(".west_lake").hide();
    });
    $(".btn_queen_anne").click(function(){
        $(".belletown").hide();
        $(".ballard").hide();
        $(".beacon_hill").hide();
        $(".capitol_hill").hide();
        ...
        $(".green_lake").hide();
        $(".east_lake").hide();
        $(".queen_anne").fadeIn(1000);
        $(".south_lake_union").hide();
        $(".west_lake").hide();
    });
    $(".btn_south_lake_union").click(function(){
        $(".belletown").hide();
        $(".ballard").hide();
        $(".beacon_hill").hide();
        $(".capitol_hill").hide();
        ...
        $(".east_lake").hide();
        $(".queen_anne").hide();
        $(".south_lake_union").fadeIn(1000);
        $(".west_lake").hide();
    });
    $(".btn_west_lake").click(function(){
        $(".belletown").hide();
        $(".ballard").hide();
        $(".beacon_hill").hide();
        $(".capitol_hill").hide();
...
$(window).load(function () {
    $(".steps_to_buying").fadeIn(1000);
    $(".facts_and_common_myths").hide();
    $(".technology_and_cervices").hide();
    $(".resources").hide();
});

$(document).ready(function(){
    
    $(".btn_steps_to_buying").click(function(){
        $(".steps_to_buying").fadeIn(1000);
        $(".facts_and_common_myths").hide();
        $(".technology_and_cervices").hide();
        $(".resources").hide();
    ...
    $(".btn_facts_and_common_myths").click(function(){
        $(".steps_to_buying").hide();
        $(".facts_and_common_myths").fadeIn(1000);
        $(".technology_and_cervices").hide();
        $(".resources").hide();
    });
    
    $(".btn_technology_and_cervices").click(function(){
        $(".steps_to_buying").hide();
        $(".facts_and_common_myths").hide();
        $(".technology_and_cervices").fadeIn(1000);
        $(".resources").hide();
    });
...
$(document).ready(function(){
    ...
    $(".btn_steps_to_selling").click(function(){
        $(".steps_to_selling").fadeIn(1000);
        $(".strategies").hide();
        $(".technology").hide();
        $(".resources").hide();
    ...
    $(".btn_strategies").click(function(){
        $(".steps_to_selling").hide();
        $(".strategies").fadeIn(1000);
        $(".technology").hide();
        $(".resources").hide();
    });
